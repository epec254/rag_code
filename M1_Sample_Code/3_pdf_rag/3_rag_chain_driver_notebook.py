...
dbutils.widgets.text("model_name", "pdf_rag_bot", "Model Name")
...
# MAGIC
# MAGIC In order to deliver high-quality RAG applications, Databricks recommends following an evaluation-driven approach to development.  To start your development process, we suggest starting with ~10 examples of questions that your users will expect your RAG application to answer correctly.  Over the course of your development process, you will expand this evaluation set.
# MAGIC
...
# Update this config from the output of `1_load_pdf_vector_index`
baseline_config = {
    "vector_search_endpoint_name": "mani_test",
    "vector_search_index": "ep_05_08_release.rag.gold_pdf_docs_chunked_index",
...
# MAGIC Alternatively, the metrics and evaluation results (including the LLM judge)
